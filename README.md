...
1. **Commits pequenos e atômicos** – uma única intenção por commit.  
2. **Usar inglês técnico** – facilita colaboração global e automação.  
3. **Não use ponto final na mensagem curta.**  
4. **Mantenha até 72 caracteres na linha de resumo.**  
5. **Conecte issues** (`Closes #123`, `Refs #456`).  
6. **Evite commits genéricos:** ❌ “update code”, “fix bug”, “changes”.
